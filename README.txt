...
In this project, we propose a interpretable font generation system with synthesised texture based on Generative Adversarial Networks (GANs) and Convolutional Neural Networks (CNNs).
...
or you can play around the model from Google Colab:
...
If you want to train your own model, you need to download font dataset from google drive: https://drive.google.com/drive/folders/1kmd-IQOUktefLss5WiF7ZASKrJxlzSNv?usp=sharing
