...
parser.add_argument("--batch_size", type=int, default=140, help="size of the batches")
...
parser.add_argument("--training_dir", type=str, default="./data/GAN_training_data/dafont/comic", help="style font training directory")
...
parser.add_argument("--trained_dir", type=str, default="./models/generator_comic.pt", help="GANs generator model directory")
